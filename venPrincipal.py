...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.layoutFormulario.addWidget(self.btnAltaCli, 0, 8, 1, 1)
        ...
        self.layoutFormulario.addWidget(self.txtCalendarCli, 0, 7, 1, 1)
        ...
        self.layoutFormulario.addWidget(self.lblCalendarCli, 0, 6, 1, 1)
